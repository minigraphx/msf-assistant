...
def privacy_body(operator: Operator | None, public_url: str) -> str:
    ...
    return (
        ...
        f"<p>Last updated: {LAST_UPDATED}. This notice applies to the MSF Assistant operated "
        f"at {host}.</p>"
        "<h2>1. Controller</h2>"
        ...
        "protected MCP interface. It is a private, non-commercial service with no "
        "affiliation to Scopely, Marvel, OpenAI or Anthropic.</p>"
        ...
        "and catalog information, only for your own account.</li>"
        ...
        "</ul>"
        "<h2>6. Retention</h2>"
        "<p>Your account, credentials, game data and context are kept until you delete your "
        "account. Access tokens of connected clients expire after 15 minutes, refresh tokens "
        "after at most 30 days or on revocation. Browser sessions end after 8 hours. Backups "
        "are kept for disaster recovery and expire on a rolling basis under a retention of "
        "at most 30 archives; a deletion takes effect there only when the respective copy "
        "expires.</p>"
        "<h2>7. Your rights</h2>"
...
def terms_body(operator: Operator | None, public_url: str) -> str:
    ...
    return (
        ...
        f"<p>Last updated: {LAST_UPDATED}. These terms govern the use of the MSF Assistant "
        f"at {host}.</p>"
        "<h2>1. Provider and nature of the service</h2>"
        + _operator_block(operator, "Provider")
        + "<p>The service is a private, non-commercial hobby project. It is not affiliated "
        "with Scopely, Marvel, OpenAI or Anthropic. “Marvel Strike Force” and "
        "“MSF” are trademarks of their respective owners.</p>"
        "<h2>2. Service</h2>"
        "<p>The service makes your own MSF game data and your stored advisor context available "
        "through an MCP interface to the AI assistant you connect. Recommendations are "
        "produced by the assistant and are AI-generated; they are provided without warranty "
        "of accuracy, currency or in-game success.</p>"
